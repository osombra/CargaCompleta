...
server = 'SQLEXPRESS'  # substitua 'localhost\SQLEXPRESS' pelo nome do servidor do seu SQL Server Express
...
password = '******'  # substitua 'sua_senha' pela senha do banco de dados
